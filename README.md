...
## From ports/packages
bhyve-firmware (sysutils/bhyve-firmware), doas (security/doas) or sudo (security/sudo), qemu-tools (emulatorsd/qemu@tools), vncviewer (net/tigervnc-viewer), swtpm (sysutils/swtpm), and xfreerdp3 (net/freerdp3)
